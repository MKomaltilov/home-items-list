...
urlpatterns = [
    ...
    path('items/<uuid:item_id>', items.get_item, name='item'),
    ...
    path('categories/<uuid:category_id>', categories.get_category, name='category'),
    path('rooms/', rooms.rooms_overview, name='rooms'),
    path('rooms/<uuid:room_id>', rooms.get_room, name='room'),
